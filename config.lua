...
-- ==== MIRRORS ====
local e_count = { enabled = true, x = 1500, y = 400, size = 5, colorkey = true }
local thin_pie = { enabled = true, x = 1490, y = 645, size = 4, colorkey = true } -- Turning off colorkeying also maintains the original pie chart's dimensions and shows the percentages
local thin_percent = { enabled = true, x = 1568, y = 1050, size = 6 }
local tall_pie = { enabled = true, x = 1490, y = 645, size = 4, colorkey = true } -- Leave same as thin for seamlessness
local tall_percent = { enabled = true, x = 1568, y = 1050, size = 6 }             -- Leave same as thin for seamlessness
...
-- ==== MISC ====
local remaps_text_config = { text = "REBINDS OFF", x = 30, y = 100, size = 3 }
local res_1440 = true
